...
CREATE TABLE `customers` (
  ...
  `customer_postal` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `enquiries` (
  ...
  `enquiry_full_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `enquiry_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `enquiry_body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `enquiry_created_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `enquiry_email_sent` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `enquiries` (`enquiry_id`, `enquiry_full_name`, `enquiry_email`, `enquiry_body`, `enquiry_created_time`, `enquiry_email_sent`) VALUES
...
--
ALTER TABLE `enquiries`
  MODIFY `enquiry_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
INSERT INTO `order_lines` (`order_lines_id`, `product_id`, `quantity`, `order_id`) VALUES
(6, 2, 2, 1);
-- --------------------------------------------------------
...
--
ALTER TABLE `order_lines`
  MODIFY `order_lines_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

ALTER TABLE `order_lines`
  ADD CONSTRAINT `order_lines_ibfk_4` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `order_lines_ibfk_6` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE;
