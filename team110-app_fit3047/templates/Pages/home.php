...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <ul class="navbar-nav ms-auto py-4 py-lg-0">
            <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" style="color:black" href="<?= $this->Url->build('/') ?>">Home</a></li>
        </ul>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <li class="nav-item"><a class="nav-link" style="color:black" href="<?= $this->Url->build('/Enquiries/add') ?>">Send Enquiry</a></li>
                </li>
                ...
                <?php else: ?>
                    <li class="nav-item">
                    <li class="nav-item"><a class="nav-link" style="color:black" href="<?= $this->Url->build('/admin') ?>">Account/Login</a></li>
                    </li>
                <?php endif ?>
            </ul>
        </div>
